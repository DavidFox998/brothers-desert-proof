...
// Module: Beal.B04_Modular
// Imports: Init Beal.B04_Modular_Core Beal.B03_Conductor
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Beal_B04__Modular(uint8_t builtin, lean_object* w) {
lean_object * res;
