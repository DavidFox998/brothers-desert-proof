...
#print axioms BealFreyConductor.Rad
#print axioms BealFreyConductor.rad_dvd_self
...
def main : IO Unit :=
  IO.println "B14/B05 boundary audit declarations compiled; inspect the axiom report above."