# AGENTS.md — birch-swinnerton-dyer-143a1

## Role: BSD-CLUSTER

**Cluster:** Birch–Swinnerton-Dyer

**Core claim:** BSD conjecture on the 143a1 elliptic curve — rank vs L-function vanishing order
...
THIS     → birch-swinnerton-dyer-143a1
```
...
expressed in the language of Birch–Swinnerton-Dyer.

## Entry point for AI agents

Look for `143a1` or `BSD` Lean files.
